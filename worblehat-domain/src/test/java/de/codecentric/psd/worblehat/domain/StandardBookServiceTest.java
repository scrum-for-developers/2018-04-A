...
public class StandardBookServiceTest {
	...
	@Before
	public void setup() {
		aBook = new Book("title", "description", "author", "edition", "isbn", 2016);
		aCopyofBook = new Book("title", "description", "author", "edition", "isbn", 2016);
		anotherBook = new Book("title2", "description2", "author2", "edition2", "isbn2", 2016);

		aBorrowedBook = new Book("title", "description", "author", "edition", "isbn", 2016);
		aBorrowing = new Borrowing(aBorrowedBook, BORROWER_EMAIL, NOW);
		aBorrowedBook.borrowNowByBorrower(BORROWER_EMAIL);

		aCopyofBorrowedBook = new Book("title", "description", "author", "edition", "isbn", 2016);
		...
		anotherBorrowedBook = new Book("title2", "description2", "author2", "edition2", "isbn2", 2016);
	...
	public void shouldCreateBook() {
		...
		bookService.createBook(aBook.getTitle(), aBook.getDescription(), aBook.getAuthor(), aBook.getEdition(),
	...
	public void shouldNotCreateAnotherCopyOfExistingBookWithDifferentTitle() {
		givenALibraryWith(aBook);
		bookService.createBook(aBook.getTitle() + "X", aBook.getDescription(), aBook.getAuthor(), aBook.getEdition(),
				aBook.getIsbn(), aBook.getYearOfPublication());
	...
	public void shouldNotCreateAnotherCopyOfExistingBookWithDifferentAuthor() {
		givenALibraryWith(aBook);
		bookService.createBook(aBook.getTitle(), aBook.getDescription(), aBook.getAuthor() + "X", aBook.getEdition(),
				aBook.getIsbn(), aBook.getYearOfPublication());
		verify(bookRepository, times(0)).save(any(Book.class));
	}
